...
type IdpGitlabSelfHostedInitParameters struct {
...
type IdpGitlabSelfHostedObservation struct {
...
// IdpGitlabSelfHostedSpec defines the desired state of IdpGitlabSelfHosted
type IdpGitlabSelfHostedSpec struct {
	...
	// autoscaler.
	InitProvider IdpGitlabSelfHostedInitParameters `json:"initProvider,omitempty"`
}

// IdpGitlabSelfHostedStatus defines the observed state of IdpGitlabSelfHosted.
...
// IdpGitlabSelfHosted is the Schema for the IdpGitlabSelfHosteds API. Resource representing a GitLab Self Hosted IDP on the instance.
...
// IdpGitlabSelfHostedList contains a list of IdpGitlabSelfHosteds
...
var (
	IdpGitlabSelfHosted_Kind             = "IdpGitlabSelfHosted"
	IdpGitlabSelfHosted_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpGitlabSelfHosted_Kind}.String()
	IdpGitlabSelfHosted_KindAPIVersion   = IdpGitlabSelfHosted_Kind + "." + CRDGroupVersion.String()
	IdpGitlabSelfHosted_GroupVersionKind = CRDGroupVersion.WithKind(IdpGitlabSelfHosted_Kind)
)
