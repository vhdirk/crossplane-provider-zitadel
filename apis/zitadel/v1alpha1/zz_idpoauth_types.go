...
type IdpOauthInitParameters struct {
...
type IdpOauthObservation struct {
...
// IdpOauthSpec defines the desired state of IdpOauth
type IdpOauthSpec struct {
	...
	// autoscaler.
	InitProvider IdpOauthInitParameters `json:"initProvider,omitempty"`
}

// IdpOauthStatus defines the observed state of IdpOauth.
...
// IdpOauth is the Schema for the IdpOauths API. Resource representing a generic OAuth2 IDP on the instance.
...
// IdpOauthList contains a list of IdpOauths
...
var (
	IdpOauth_Kind             = "IdpOauth"
	IdpOauth_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpOauth_Kind}.String()
	IdpOauth_KindAPIVersion   = IdpOauth_Kind + "." + CRDGroupVersion.String()
	IdpOauth_GroupVersionKind = CRDGroupVersion.WithKind(IdpOauth_Kind)
)
