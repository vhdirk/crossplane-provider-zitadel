...
type OrganizationIdpAzureAdInitParameters struct {
...
type OrganizationIdpAzureAdObservation struct {
...
type OrganizationIdpAzureAdParameters struct {
...
// OrganizationIdpAzureAdSpec defines the desired state of OrganizationIdpAzureAd
type OrganizationIdpAzureAdSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganizationIdpAzureAdParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganizationIdpAzureAdInitParameters `json:"initProvider,omitempty"`
}

// OrganizationIdpAzureAdStatus defines the observed state of OrganizationIdpAzureAd.
type OrganizationIdpAzureAdStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganizationIdpAzureAdObservation `json:"atProvider,omitempty"`
}
...
// OrganizationIdpAzureAd is the Schema for the OrganizationIdpAzureAds API. Resource representing an Azure AD IdP on the organization.
...
type OrganizationIdpAzureAd struct {
	...
	Spec   OrganizationIdpAzureAdSpec   `json:"spec"`
	Status OrganizationIdpAzureAdStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganizationIdpAzureAdList contains a list of OrganizationIdpAzureAds
type OrganizationIdpAzureAdList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganizationIdpAzureAd `json:"items"`
}

// Repository type metadata.
var (
	OrganizationIdpAzureAd_Kind             = "OrganizationIdpAzureAd"
	OrganizationIdpAzureAd_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganizationIdpAzureAd_Kind}.String()
	OrganizationIdpAzureAd_KindAPIVersion   = OrganizationIdpAzureAd_Kind + "." + CRDGroupVersion.String()
	OrganizationIdpAzureAd_GroupVersionKind = CRDGroupVersion.WithKind(OrganizationIdpAzureAd_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganizationIdpAzureAd{}, &OrganizationIdpAzureAdList{})
}
