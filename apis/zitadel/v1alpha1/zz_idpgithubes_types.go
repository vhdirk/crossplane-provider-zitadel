...
type IdpGithubEsInitParameters struct {
...
type IdpGithubEsObservation struct {
...
type IdpGithubEsParameters struct {
...
// IdpGithubEsSpec defines the desired state of IdpGithubEs
type IdpGithubEsSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     IdpGithubEsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider IdpGithubEsInitParameters `json:"initProvider,omitempty"`
}

// IdpGithubEsStatus defines the observed state of IdpGithubEs.
type IdpGithubEsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        IdpGithubEsObservation `json:"atProvider,omitempty"`
}
...
// IdpGithubEs is the Schema for the IdpGithubEss API. Resource representing a GitHub Enterprise IDP on the instance.
...
type IdpGithubEs struct {
	...
	Spec   IdpGithubEsSpec   `json:"spec"`
	Status IdpGithubEsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// IdpGithubEsList contains a list of IdpGithubEss
type IdpGithubEsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []IdpGithubEs `json:"items"`
}

// Repository type metadata.
var (
	IdpGithubEs_Kind             = "IdpGithubEs"
	IdpGithubEs_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpGithubEs_Kind}.String()
	IdpGithubEs_KindAPIVersion   = IdpGithubEs_Kind + "." + CRDGroupVersion.String()
	IdpGithubEs_GroupVersionKind = CRDGroupVersion.WithKind(IdpGithubEs_Kind)
)

func init() {
	SchemeBuilder.Register(&IdpGithubEs{}, &IdpGithubEsList{})
}
