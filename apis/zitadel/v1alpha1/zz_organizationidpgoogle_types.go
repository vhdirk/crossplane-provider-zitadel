...
type OrganizationIdpGoogleInitParameters struct {
...
type OrganizationIdpGoogleObservation struct {
...
type OrganizationIdpGoogleParameters struct {
...
// OrganizationIdpGoogleSpec defines the desired state of OrganizationIdpGoogle
type OrganizationIdpGoogleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganizationIdpGoogleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganizationIdpGoogleInitParameters `json:"initProvider,omitempty"`
}

// OrganizationIdpGoogleStatus defines the observed state of OrganizationIdpGoogle.
type OrganizationIdpGoogleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganizationIdpGoogleObservation `json:"atProvider,omitempty"`
}
...
// OrganizationIdpGoogle is the Schema for the OrganizationIdpGoogles API. Resource representing a Google IdP on the organization.
...
type OrganizationIdpGoogle struct {
	...
	Spec   OrganizationIdpGoogleSpec   `json:"spec"`
	Status OrganizationIdpGoogleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganizationIdpGoogleList contains a list of OrganizationIdpGoogles
type OrganizationIdpGoogleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganizationIdpGoogle `json:"items"`
}

// Repository type metadata.
var (
	OrganizationIdpGoogle_Kind             = "OrganizationIdpGoogle"
	OrganizationIdpGoogle_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganizationIdpGoogle_Kind}.String()
	OrganizationIdpGoogle_KindAPIVersion   = OrganizationIdpGoogle_Kind + "." + CRDGroupVersion.String()
	OrganizationIdpGoogle_GroupVersionKind = CRDGroupVersion.WithKind(OrganizationIdpGoogle_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganizationIdpGoogle{}, &OrganizationIdpGoogleList{})
}
