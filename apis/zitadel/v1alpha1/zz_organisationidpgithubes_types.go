...
type OrganisationIdpGithubEsInitParameters struct {
...
type OrganisationIdpGithubEsObservation struct {
...
type OrganisationIdpGithubEsParameters struct {
...
// OrganisationIdpGithubEsSpec defines the desired state of OrganisationIdpGithubEs
type OrganisationIdpGithubEsSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganisationIdpGithubEsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganisationIdpGithubEsInitParameters `json:"initProvider,omitempty"`
}

// OrganisationIdpGithubEsStatus defines the observed state of OrganisationIdpGithubEs.
type OrganisationIdpGithubEsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganisationIdpGithubEsObservation `json:"atProvider,omitempty"`
}
...
// OrganisationIdpGithubEs is the Schema for the OrganisationIdpGithubEss API. Resource representing a GitHub Enterprise IdP on the organization.
...
type OrganisationIdpGithubEs struct {
	...
	Spec   OrganisationIdpGithubEsSpec   `json:"spec"`
	Status OrganisationIdpGithubEsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganisationIdpGithubEsList contains a list of OrganisationIdpGithubEss
type OrganisationIdpGithubEsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganisationIdpGithubEs `json:"items"`
}

// Repository type metadata.
var (
	OrganisationIdpGithubEs_Kind             = "OrganisationIdpGithubEs"
	OrganisationIdpGithubEs_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganisationIdpGithubEs_Kind}.String()
	OrganisationIdpGithubEs_KindAPIVersion   = OrganisationIdpGithubEs_Kind + "." + CRDGroupVersion.String()
	OrganisationIdpGithubEs_GroupVersionKind = CRDGroupVersion.WithKind(OrganisationIdpGithubEs_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganisationIdpGithubEs{}, &OrganisationIdpGithubEsList{})
}
