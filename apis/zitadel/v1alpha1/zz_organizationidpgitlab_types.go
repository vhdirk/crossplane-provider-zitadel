...
type OrganizationIdpGitlabInitParameters struct {
...
type OrganizationIdpGitlabObservation struct {
...
type OrganizationIdpGitlabParameters struct {
...
// OrganizationIdpGitlabSpec defines the desired state of OrganizationIdpGitlab
type OrganizationIdpGitlabSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganizationIdpGitlabParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganizationIdpGitlabInitParameters `json:"initProvider,omitempty"`
}

// OrganizationIdpGitlabStatus defines the observed state of OrganizationIdpGitlab.
type OrganizationIdpGitlabStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganizationIdpGitlabObservation `json:"atProvider,omitempty"`
}
...
// OrganizationIdpGitlab is the Schema for the OrganizationIdpGitlabs API. Resource representing a GitLab IdP on the organization.
...
type OrganizationIdpGitlab struct {
	...
	Spec   OrganizationIdpGitlabSpec   `json:"spec"`
	Status OrganizationIdpGitlabStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganizationIdpGitlabList contains a list of OrganizationIdpGitlabs
type OrganizationIdpGitlabList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganizationIdpGitlab `json:"items"`
}

// Repository type metadata.
var (
	OrganizationIdpGitlab_Kind             = "OrganizationIdpGitlab"
	OrganizationIdpGitlab_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganizationIdpGitlab_Kind}.String()
	OrganizationIdpGitlab_KindAPIVersion   = OrganizationIdpGitlab_Kind + "." + CRDGroupVersion.String()
	OrganizationIdpGitlab_GroupVersionKind = CRDGroupVersion.WithKind(OrganizationIdpGitlab_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganizationIdpGitlab{}, &OrganizationIdpGitlabList{})
}
