...
type OrganisationIdpOidcInitParameters struct {
...
type OrganisationIdpOidcObservation struct {
...
type OrganisationIdpOidcParameters struct {
...
// OrganisationIdpOidcSpec defines the desired state of OrganisationIdpOidc
type OrganisationIdpOidcSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganisationIdpOidcParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganisationIdpOidcInitParameters `json:"initProvider,omitempty"`
}

// OrganisationIdpOidcStatus defines the observed state of OrganisationIdpOidc.
type OrganisationIdpOidcStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganisationIdpOidcObservation `json:"atProvider,omitempty"`
}
...
// OrganisationIdpOidc is the Schema for the OrganisationIdpOidcs API. Resource representing a generic OIDC IdP on the organization.
...
type OrganisationIdpOidc struct {
	...
	Spec   OrganisationIdpOidcSpec   `json:"spec"`
	Status OrganisationIdpOidcStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganisationIdpOidcList contains a list of OrganisationIdpOidcs
type OrganisationIdpOidcList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganisationIdpOidc `json:"items"`
}

// Repository type metadata.
var (
	OrganisationIdpOidc_Kind             = "OrganisationIdpOidc"
	OrganisationIdpOidc_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganisationIdpOidc_Kind}.String()
	OrganisationIdpOidc_KindAPIVersion   = OrganisationIdpOidc_Kind + "." + CRDGroupVersion.String()
	OrganisationIdpOidc_GroupVersionKind = CRDGroupVersion.WithKind(OrganisationIdpOidc_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganisationIdpOidc{}, &OrganisationIdpOidcList{})
}
