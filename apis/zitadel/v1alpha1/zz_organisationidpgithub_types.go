...
type OrganisationIdpGithubInitParameters struct {
...
type OrganisationIdpGithubObservation struct {
...
type OrganisationIdpGithubParameters struct {
...
// OrganisationIdpGithubSpec defines the desired state of OrganisationIdpGithub
type OrganisationIdpGithubSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganisationIdpGithubParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganisationIdpGithubInitParameters `json:"initProvider,omitempty"`
}

// OrganisationIdpGithubStatus defines the observed state of OrganisationIdpGithub.
type OrganisationIdpGithubStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganisationIdpGithubObservation `json:"atProvider,omitempty"`
}
...
// OrganisationIdpGithub is the Schema for the OrganisationIdpGithubs API. Resource representing a GitHub IdP on the organization.
...
type OrganisationIdpGithub struct {
	...
	Spec   OrganisationIdpGithubSpec   `json:"spec"`
	Status OrganisationIdpGithubStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganisationIdpGithubList contains a list of OrganisationIdpGithubs
type OrganisationIdpGithubList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganisationIdpGithub `json:"items"`
}

// Repository type metadata.
var (
	OrganisationIdpGithub_Kind             = "OrganisationIdpGithub"
	OrganisationIdpGithub_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganisationIdpGithub_Kind}.String()
	OrganisationIdpGithub_KindAPIVersion   = OrganisationIdpGithub_Kind + "." + CRDGroupVersion.String()
	OrganisationIdpGithub_GroupVersionKind = CRDGroupVersion.WithKind(OrganisationIdpGithub_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganisationIdpGithub{}, &OrganisationIdpGithubList{})
}
