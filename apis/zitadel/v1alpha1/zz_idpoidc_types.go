...
type IdpOidcInitParameters struct {
...
type IdpOidcObservation struct {
...
// IdpOidcSpec defines the desired state of IdpOidc
type IdpOidcSpec struct {
	...
	// autoscaler.
	InitProvider IdpOidcInitParameters `json:"initProvider,omitempty"`
}

// IdpOidcStatus defines the observed state of IdpOidc.
...
// IdpOidc is the Schema for the IdpOidcs API. Resource representing a generic OIDC IDP on the instance.
...
// IdpOidcList contains a list of IdpOidcs
...
var (
	IdpOidc_Kind             = "IdpOidc"
	IdpOidc_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpOidc_Kind}.String()
	IdpOidc_KindAPIVersion   = IdpOidc_Kind + "." + CRDGroupVersion.String()
	IdpOidc_GroupVersionKind = CRDGroupVersion.WithKind(IdpOidc_Kind)
)
