...
type IdpGoogleInitParameters struct {
...
type IdpGoogleObservation struct {
...
// IdpGoogleSpec defines the desired state of IdpGoogle
type IdpGoogleSpec struct {
	...
	// autoscaler.
	InitProvider IdpGoogleInitParameters `json:"initProvider,omitempty"`
}

// IdpGoogleStatus defines the observed state of IdpGoogle.
...
// IdpGoogle is the Schema for the IdpGoogles API. Resource representing a Google IDP on the instance.
...
// IdpGoogleList contains a list of IdpGoogles
...
var (
	IdpGoogle_Kind             = "IdpGoogle"
	IdpGoogle_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpGoogle_Kind}.String()
	IdpGoogle_KindAPIVersion   = IdpGoogle_Kind + "." + CRDGroupVersion.String()
	IdpGoogle_GroupVersionKind = CRDGroupVersion.WithKind(IdpGoogle_Kind)
)
