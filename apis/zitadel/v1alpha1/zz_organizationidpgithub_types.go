...
type OrganizationIdpGithubInitParameters struct {
...
type OrganizationIdpGithubObservation struct {
...
type OrganizationIdpGithubParameters struct {
...
// OrganizationIdpGithubSpec defines the desired state of OrganizationIdpGithub
type OrganizationIdpGithubSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganizationIdpGithubParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganizationIdpGithubInitParameters `json:"initProvider,omitempty"`
}

// OrganizationIdpGithubStatus defines the observed state of OrganizationIdpGithub.
type OrganizationIdpGithubStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganizationIdpGithubObservation `json:"atProvider,omitempty"`
}
...
// OrganizationIdpGithub is the Schema for the OrganizationIdpGithubs API. Resource representing a GitHub IdP on the organization.
...
type OrganizationIdpGithub struct {
	...
	Spec   OrganizationIdpGithubSpec   `json:"spec"`
	Status OrganizationIdpGithubStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganizationIdpGithubList contains a list of OrganizationIdpGithubs
type OrganizationIdpGithubList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganizationIdpGithub `json:"items"`
}

// Repository type metadata.
var (
	OrganizationIdpGithub_Kind             = "OrganizationIdpGithub"
	OrganizationIdpGithub_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganizationIdpGithub_Kind}.String()
	OrganizationIdpGithub_KindAPIVersion   = OrganizationIdpGithub_Kind + "." + CRDGroupVersion.String()
	OrganizationIdpGithub_GroupVersionKind = CRDGroupVersion.WithKind(OrganizationIdpGithub_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganizationIdpGithub{}, &OrganizationIdpGithubList{})
}
