...
type DefaultLoginPolicyInitParameters struct {
...
type DefaultLoginPolicySpec struct {
	...
	// autoscaler.
	InitProvider DefaultLoginPolicyInitParameters `json:"initProvider,omitempty"`
}
...
// DefaultLoginPolicy is the Schema for the DefaultLoginPolicys API. Resource representing the default login policy.
...
// DefaultLoginPolicyList contains a list of DefaultLoginPolicys
...
var (
	DefaultLoginPolicy_Kind             = "DefaultLoginPolicy"
	DefaultLoginPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DefaultLoginPolicy_Kind}.String()
	DefaultLoginPolicy_KindAPIVersion   = DefaultLoginPolicy_Kind + "." + CRDGroupVersion.String()
	DefaultLoginPolicy_GroupVersionKind = CRDGroupVersion.WithKind(DefaultLoginPolicy_Kind)
)
