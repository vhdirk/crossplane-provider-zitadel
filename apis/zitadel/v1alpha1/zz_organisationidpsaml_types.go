...
type OrganisationIdpSamlInitParameters struct {
...
type OrganisationIdpSamlObservation struct {
...
type OrganisationIdpSamlParameters struct {
...
// OrganisationIdpSamlSpec defines the desired state of OrganisationIdpSaml
type OrganisationIdpSamlSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganisationIdpSamlParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganisationIdpSamlInitParameters `json:"initProvider,omitempty"`
}

// OrganisationIdpSamlStatus defines the observed state of OrganisationIdpSaml.
type OrganisationIdpSamlStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganisationIdpSamlObservation `json:"atProvider,omitempty"`
}
...
// OrganisationIdpSaml is the Schema for the OrganisationIdpSamls API. Resource representing a SAML IdP on the organization.
...
type OrganisationIdpSaml struct {
	...
	Spec   OrganisationIdpSamlSpec   `json:"spec"`
	Status OrganisationIdpSamlStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganisationIdpSamlList contains a list of OrganisationIdpSamls
type OrganisationIdpSamlList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganisationIdpSaml `json:"items"`
}

// Repository type metadata.
var (
	OrganisationIdpSaml_Kind             = "OrganisationIdpSaml"
	OrganisationIdpSaml_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganisationIdpSaml_Kind}.String()
	OrganisationIdpSaml_KindAPIVersion   = OrganisationIdpSaml_Kind + "." + CRDGroupVersion.String()
	OrganisationIdpSaml_GroupVersionKind = CRDGroupVersion.WithKind(OrganisationIdpSaml_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganisationIdpSaml{}, &OrganisationIdpSamlList{})
}
