...
type OrganisationIdpAzureAdInitParameters struct {
...
type OrganisationIdpAzureAdObservation struct {
...
type OrganisationIdpAzureAdParameters struct {
...
// OrganisationIdpAzureAdSpec defines the desired state of OrganisationIdpAzureAd
type OrganisationIdpAzureAdSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganisationIdpAzureAdParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganisationIdpAzureAdInitParameters `json:"initProvider,omitempty"`
}

// OrganisationIdpAzureAdStatus defines the observed state of OrganisationIdpAzureAd.
type OrganisationIdpAzureAdStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganisationIdpAzureAdObservation `json:"atProvider,omitempty"`
}
...
// OrganisationIdpAzureAd is the Schema for the OrganisationIdpAzureAds API. Resource representing an Azure AD IdP on the organization.
...
type OrganisationIdpAzureAd struct {
	...
	Spec   OrganisationIdpAzureAdSpec   `json:"spec"`
	Status OrganisationIdpAzureAdStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganisationIdpAzureAdList contains a list of OrganisationIdpAzureAds
type OrganisationIdpAzureAdList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganisationIdpAzureAd `json:"items"`
}

// Repository type metadata.
var (
	OrganisationIdpAzureAd_Kind             = "OrganisationIdpAzureAd"
	OrganisationIdpAzureAd_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganisationIdpAzureAd_Kind}.String()
	OrganisationIdpAzureAd_KindAPIVersion   = OrganisationIdpAzureAd_Kind + "." + CRDGroupVersion.String()
	OrganisationIdpAzureAd_GroupVersionKind = CRDGroupVersion.WithKind(OrganisationIdpAzureAd_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganisationIdpAzureAd{}, &OrganisationIdpAzureAdList{})
}
