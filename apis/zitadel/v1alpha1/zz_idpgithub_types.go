...
type IdpGithubInitParameters struct {
...
type IdpGithubObservation struct {
...
// IdpGithubSpec defines the desired state of IdpGithub
type IdpGithubSpec struct {
	...
	// autoscaler.
	InitProvider IdpGithubInitParameters `json:"initProvider,omitempty"`
}

// IdpGithubStatus defines the observed state of IdpGithub.
...
// IdpGithub is the Schema for the IdpGithubs API. Resource representing a GitHub IDP on the instance.
...
// IdpGithubList contains a list of IdpGithubs
...
var (
	IdpGithub_Kind             = "IdpGithub"
	IdpGithub_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpGithub_Kind}.String()
	IdpGithub_KindAPIVersion   = IdpGithub_Kind + "." + CRDGroupVersion.String()
	IdpGithub_GroupVersionKind = CRDGroupVersion.WithKind(IdpGithub_Kind)
)
