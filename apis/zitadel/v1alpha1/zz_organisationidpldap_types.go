...
type OrganisationIdpLdapInitParameters struct {
...
type OrganisationIdpLdapObservation struct {
...
type OrganisationIdpLdapParameters struct {
...
// OrganisationIdpLdapSpec defines the desired state of OrganisationIdpLdap
type OrganisationIdpLdapSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganisationIdpLdapParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganisationIdpLdapInitParameters `json:"initProvider,omitempty"`
}

// OrganisationIdpLdapStatus defines the observed state of OrganisationIdpLdap.
type OrganisationIdpLdapStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganisationIdpLdapObservation `json:"atProvider,omitempty"`
}
...
// OrganisationIdpLdap is the Schema for the OrganisationIdpLdaps API. Resource representing an LDAP IdP on the organization.
...
type OrganisationIdpLdap struct {
	...
	Spec   OrganisationIdpLdapSpec   `json:"spec"`
	Status OrganisationIdpLdapStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganisationIdpLdapList contains a list of OrganisationIdpLdaps
type OrganisationIdpLdapList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganisationIdpLdap `json:"items"`
}

// Repository type metadata.
var (
	OrganisationIdpLdap_Kind             = "OrganisationIdpLdap"
	OrganisationIdpLdap_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganisationIdpLdap_Kind}.String()
	OrganisationIdpLdap_KindAPIVersion   = OrganisationIdpLdap_Kind + "." + CRDGroupVersion.String()
	OrganisationIdpLdap_GroupVersionKind = CRDGroupVersion.WithKind(OrganisationIdpLdap_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganisationIdpLdap{}, &OrganisationIdpLdapList{})
}
