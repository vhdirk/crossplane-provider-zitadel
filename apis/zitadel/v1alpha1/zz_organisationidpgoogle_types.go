...
type OrganisationIdpGoogleInitParameters struct {
...
type OrganisationIdpGoogleObservation struct {
...
type OrganisationIdpGoogleParameters struct {
...
// OrganisationIdpGoogleSpec defines the desired state of OrganisationIdpGoogle
type OrganisationIdpGoogleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrganisationIdpGoogleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrganisationIdpGoogleInitParameters `json:"initProvider,omitempty"`
}

// OrganisationIdpGoogleStatus defines the observed state of OrganisationIdpGoogle.
type OrganisationIdpGoogleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrganisationIdpGoogleObservation `json:"atProvider,omitempty"`
}
...
// OrganisationIdpGoogle is the Schema for the OrganisationIdpGoogles API. Resource representing a Google IdP on the organization.
...
type OrganisationIdpGoogle struct {
	...
	Spec   OrganisationIdpGoogleSpec   `json:"spec"`
	Status OrganisationIdpGoogleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrganisationIdpGoogleList contains a list of OrganisationIdpGoogles
type OrganisationIdpGoogleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrganisationIdpGoogle `json:"items"`
}

// Repository type metadata.
var (
	OrganisationIdpGoogle_Kind             = "OrganisationIdpGoogle"
	OrganisationIdpGoogle_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganisationIdpGoogle_Kind}.String()
	OrganisationIdpGoogle_KindAPIVersion   = OrganisationIdpGoogle_Kind + "." + CRDGroupVersion.String()
	OrganisationIdpGoogle_GroupVersionKind = CRDGroupVersion.WithKind(OrganisationIdpGoogle_Kind)
)

func init() {
	SchemeBuilder.Register(&OrganisationIdpGoogle{}, &OrganisationIdpGoogleList{})
}
