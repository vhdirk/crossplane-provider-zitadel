...
type IdpLdapInitParameters struct {
...
type IdpLdapObservation struct {
...
// IdpLdapSpec defines the desired state of IdpLdap
type IdpLdapSpec struct {
	...
	// autoscaler.
	InitProvider IdpLdapInitParameters `json:"initProvider,omitempty"`
}

// IdpLdapStatus defines the observed state of IdpLdap.
...
// IdpLdap is the Schema for the IdpLdaps API. Resource representing an LDAP IDP on the instance.
...
// IdpLdapList contains a list of IdpLdaps
...
var (
	IdpLdap_Kind             = "IdpLdap"
	IdpLdap_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdpLdap_Kind}.String()
	IdpLdap_KindAPIVersion   = IdpLdap_Kind + "." + CRDGroupVersion.String()
	IdpLdap_GroupVersionKind = CRDGroupVersion.WithKind(IdpLdap_Kind)
)
